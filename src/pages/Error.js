		...
		<div className="videoH bg-secondary">
			<article className="bg-secondary w-full aboutH flex flex-col items-center py-10">
				<div className="w-4/5 h-4/5 bg-white flex flex-col items-center my-4 px-4 py-3 rounded-3xl shadow">
					...
					<Link to="/" className="text-center text-4xl bg-tertiary w-40 h-14 p-1 rounded-full flex-wrap content-start text-2xl text-bold text-white transform transition duration-700 hover:scale-105 hover:text-black">
						Home
					</Link>
				</div>
			</article>
